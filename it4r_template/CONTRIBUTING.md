# it4r_python_template Contributing Guide

Hi! Thanks for taking the time to contribute to it4r_python_template.

_You can contribute in many ways_

- Join the [discussion](https://github.com/it4r_python_template/discussions)

_Before submitting your contribution, please make sure to take a moment and read through the following guidelines_

- [Code of Conduct](https://github.com/it4r_python_template/blob/main/CODE_OF_CONDUCT.md)
...
- Always use [ issue templates ](https://github.com/it4r_python_template/issues/new/choose)
